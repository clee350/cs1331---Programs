...
public class PacmanGamePanel extends JPanel {
     ...
     *your own level files, simply provide a new level.txt file
     ...
     * @param: passes in the graphics component.
     */
    @Override
    ...
    /*
     * Class:This is a class that allows the pacman to be controlled
    ...
    private class PacmanControls implements KeyListener {
        ...
        /**
         * Method: sets up the key controls associated
         * with the game.
         * @param: A KeyEvent is passed in.
         */
        ...
        /**
         * Method: method in KeyListener that we do not want to use, 
         * so we just override it with an empty method body
         * @param: passes in a KeyEvent parameter.
         */
    ...
    /* 
     * Class:This is the actionlistener that we have tied to our timer.
    ...
    private class GameUpdater implements ActionListener {
         ...
         * so we just override it with an empty method body
         * @param: passes in an ActionEvent parameter.
         */        
